  ...
  return (
    <div>
      <h1 className="sr-only">
        Hello I&apos;m Harsh Singh, I&apos;m a ML Engineer passionate about building models that solve real-world problems efficiently.
      </h1>
          ...
          <div className="-mt-36">
            <div ref={ref} className="flex cursor-default flex-col space-y-2">
              ...
              <h2 className="text-3xl font-medium opacity-80 sm:text-6xl md:text-6xl xl:text-7xl">
                On the path to becoming a ML Engineer.
              </h2>
              <Link
                href="/about"
